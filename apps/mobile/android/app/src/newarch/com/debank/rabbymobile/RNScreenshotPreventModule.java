...
@ReactModule(name = RNScreenshotPreventModule.NAME)
public class RNScreenshotPreventModule extends NativeRNScreenshotPreventSpec /* implements LifecycleEventListener */ {
  ...
  @Override
  public void scanScreenshotDirectory() {}
